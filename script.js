...
function mensflor1(){
    document.getElementById('dia-maes').style.visibility = 'hidden';
    document.getElementById('p-maes').style.visibility = 'hidden';
    document.getElementById('mens').style.backgroundColor = '#7f40be';
    document.getElementById('mens').classList.add('mostrar');
    document.getElementById('p-mens').style.display = 'block';
...
function mensflor2(){
    document.getElementById('dia-maes').style.visibility = 'hidden';
    document.getElementById('p-maes').style.visibility = 'hidden';
    document.getElementById('mens').style.backgroundColor = '#f35f93';
    document.getElementById('mens').classList.add('mostrar');
    document.getElementById('p-mens').style.display = 'block';
...
function mensflor3(){
    document.getElementById('dia-maes').style.visibility = 'hidden';
    document.getElementById('p-maes').style.visibility = 'hidden';
    document.getElementById('mens').style.backgroundColor = '#b82a1d';
    document.getElementById('mens').classList.add('mostrar');
    document.getElementById('p-mens').style.display = 'block';
